...
def train_model(num_epochs=10):
    ...
    dataset = EyeMovementDataset(annotations_file= os.path.expand'~/Documents/python projects/SmartMirror/data/labels.csv', 
                                 img_dir= os.path.expand'~/Documents/python projects/SmartMirror/data/images', 
                                 transform=transform)
